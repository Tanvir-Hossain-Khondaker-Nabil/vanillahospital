...
$data['data'] = [
    'name' => 'Dashboard',
    'title'=>'Dashboard',
    'heading' => trans('dashboard.accounting_dashboard'),
];
?>
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="{{ route('member.items.index') }}" class="small-box-footer">{{__('dashboard.more_info')}} <i
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="{{ route('member.purchase.index') }}" class="small-box-footer">{{__('dashboard.more_info')}} <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="{{ route('member.sales.index') }}" class="small-box-footer">{{__('dashboard.more_info')}} <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="{{ route('member.users.index') }}" class="small-box-footer">{{__('dashboard.more_info')}} <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="text-wrap:wrap;">{{__('dashboard.today_income')}} (CR)</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="text-wrap:wrap;">{{__('dashboard.total_income')}} (CR)</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="text-wrap:wrap;">{{__('dashboard.today_expense')}} (Dr)</span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="text-wrap:wrap;">{{__('dashboard.total_expense')}} (Dr)</span>
        ...
        <script>
            $(function() {
                ...
                var donutData = [{
                        ...
                        data: $total_transport_cost,
                        color: '#3c8dbc'
                    },
                    {
                        label: 'Unload Cost',
                        data: $total_unload_cost,
                        color: '#0073b7'
                    },
