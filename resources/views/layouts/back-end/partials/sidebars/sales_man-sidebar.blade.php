...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if($user->can([
            'member.report.dealer_daily_stocks',
            'member.report.dealer_stocks',
            'member.report.daily_stock_by_rsrd',
            'member.report.requistion_report',
            'member.report.salesman_requistion_report']))
