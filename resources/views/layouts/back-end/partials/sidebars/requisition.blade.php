                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    @if( $user->can([ 'member.report.dealer_daily_stocks']))
                                        <li> <a href="{{ route('member.report.dealer_daily_stocks') }}"> Dealer {{ __('report.daily_stocks') }}</a>  </li>
                                    @endif

                                    @if( $user->can([ 'member.report.dealer_stocks']))
                                        <li><a href="{{ route('member.report.dealer_stocks') }}"> Dealer {{ __('report.stocks') }}</a> </li>
                                    @endif
            ...
            @if($user->can(['member.customers.index', 'member.customers.create']))
                <li class="treeview">
                    <a href="javascript:void(0)">
                        ...
                        <span> {{__('common.dealer_shopkeepers')}}</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        @if($user->can(['member.customers.index']))
                            <li><a href="{{ route('member.customers.index') }}"><i class="fa fa-users"></i> {{__('common.shopkeepers')}}</a>
                            </li>
                        @endif
                        @if($user->can(['member.customers.create' ]))
                            <li><a href="{{ route('member.customers.create', 'customer') }}"><i class="fa fa-plus"></i>  {{__('common.add_shopkeeper')}}</a></li>
                        @endif
                    </ul>
                </li>
            @endif
