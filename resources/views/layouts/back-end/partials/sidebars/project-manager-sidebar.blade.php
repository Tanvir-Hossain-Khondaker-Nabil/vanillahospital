...
<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            {{--<li>--}}
                {{--<a href="{{route('member.task.create')}}">--}}
                    {{--<i class="fa fa-tasks"></i><span>{{ __('Create Task') }}</span>--}}
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{route('member.task.index')}}">
                            <i class="fa fa-tasks"></i> {{ __('Task List') }}</a>
                    </li>

                    <li><a href="{{ route('member.task.create') }}">
                            <i class="fa fa-plus-circle"></i> {{ __('Create') }}</a>
                    </li>
            ...
            <li>
                ...
                {{-- <a href="{{route('employee.users.project.index')}}"> --}}
