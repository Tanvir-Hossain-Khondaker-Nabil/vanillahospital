...
<div class="col-md-6">
    <div class="form-group">
        <label for="name">Thana Name <span class="text-red"> * </span> </label>
    ...
    <div class="form-group">
        ...
        {!! Form::select('district_id',$districts, null,['id'=>'district_id','class'=>'form-control select2  select-district-area','placeholder'=>'Please select']); !!}
    </div>
