        ...
        <div class="col-lg-12">
            <table class="table table-striped dataTable">
                <tbody>
                    ...
                    <tr>
                        <th class="text-uppercase" >1A. Sales</th>
                        <th class="text-right">{{ create_money_format($total_sales) }}</th>
                    </tr>
                    <tr>
                        <th class="text-uppercase" >1B. Sales Return</th>
                        <th class="text-right">{{ create_money_format($total_sales_return) }}</th>
                    </tr>
                    <tr>
                        <th class="padding-left-40 text-uppercase " >Total(1A-1B)</th>
                        <th class=" single-line text-right">{{ create_money_format($total_sales-$total_sales_return) }}</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="padding-left-40" >B1. Purchase</td>
                        <td class="text-right">{{ create_money_format($total_purchases) }}</td>
                    </tr>
                    <tr>
                        <td class="padding-left-40" >B2. Purchase Return</td>
                        <td class="text-right">{{ create_money_format($total_purchases_return) }}</td>
                    </tr>
                    <tr>
                        <th class="padding-left-40 text-uppercase " >B. Total(B1-B2)</th>
                        <th class=" single-line text-right">{{ create_money_format($total_purchases-$total_purchases_return) }}</th>
                    </tr>
                    <tr>
                        <th class="padding-left-40 text-uppercase " >Total(A+B)</th>
                        <th class=" single-line text-right">{{ create_money_format($openingStock+$total_purchases-$total_purchases_return) }}</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class=" single-line text-right">{{ create_money_format($openingStock+$total_purchases-$total_purchases_return-$total_inventory) }}</th>
                    </tr>

                    @php
                        $total_cost_of_sold = $openingStock+$total_purchases-$total_purchases_return-$total_inventory+$cost_of_sold_balance;
                    @endphp
