                ...
                <div class="box-body">
                    <div class="col-lg-6" style="padding-left: 0;padding-right: 0;">
                        <table class="table table-striped" id="dataTable">
                            ...
                            @php
                                $total_credit = $last_transaction_id = $sale_id = $last_transaction = $transactions_id = $transaction_details_id = $sale_print = 0 ;
                                ...
                                <tr>
                                    ...
                                    @else
                                        ...
                                        <td  class="border-right-1 text-right" >
                                            ...
                                            {{ create_money_format($value->amount) }}
                    ...
                    <div class="col-lg-6" style="padding-left: 0;padding-right: 0;">
                        <table class="table table-striped" id="dataTable">
                            ...
                            @php
                                $total_debit = $last_transaction = $last_transaction_id = $transactions_id = $transaction_details_id = $purchase_print = 0 ;
