                   ...
                   @include('member.reports.common._modal_balance_sheet_v2')
                    ...
                    <div class="col-lg-6">
                        <table class="table table-striped" id="dataTable">
                            ...
                            <tr>
                                <th class="text-uppercase padding-left-40"> <a href="javascript:void(0)" data-toggle="modal" data-target="#equity"> Equity </a></th>
                            ...
                            <tr>
                                <th class="text-uppercase border-top-1" >Total Equity</th>
