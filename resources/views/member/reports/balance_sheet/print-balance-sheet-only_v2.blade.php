...
$pre_total_current_asset = $pre_total_inventory+$pre_total_trade_debtor+$pre_total_cash_bank+$pre_total_account_receivables+$pre_total_current_asset+$pre_total_advance_prepayment+$pre_total_due_affiliated_company+$pre_total_fixed_deposits_receipt;
                ...
                <tr>
                    <th class="text-uppercase padding-left-40" colspan="1"> equity</th>
                    <td class="text-right">{{ create_money_format($pre_total_equity) }}</td>
                    <td class="text-right">{{ create_money_format($total_equity) }}</td>
                </tr>
                @php
                ...
                <tr>
                    <th class="text-uppercase border-top-1" colspan="1">Total Equity</th>
