...
$data['data'] = [
    ...
    'heading' => trans('common.purchase_return_report'),
];
...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            {!! Form::open(['route' => 'member.report.purchase_return_report','method' => 'GET', 'role'=>'form' ]) !!}
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{__('common.purchase_return_report')}}</h3>
                    ...
                    <div class="col-lg-12">
                        <table class="report-table table table-striped" id="dataTable">
                            ...
                            @foreach($purchases as $key => $value)
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td class="text-center">{{ db_date_month_year_format($value->return_date) }}</td>
