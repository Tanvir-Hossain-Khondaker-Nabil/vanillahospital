 ...
 *
 *
 *  DAILY SHEET DEVELOP BY PER Price to TOTAL price conversion Rate.
 *
 * ONLY PER PRICE to Total Price COUNTED
 */
...
$data['data'] = [
    ...
    'heading' =>trans('common.daily_sheet_report'),
];
        ...
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <label>{{__('common.transaction_type')}}  </label>
...
{{--                                <option value="due"> Due Receipt</option>--}}
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">{{__('common.daily_sheet_report')}} {{ $report_date }}</h3>
                    ...
                    <a class="btn btn-sm  btn-warning pull-right mx-2" href="{{ route(Route::current()->getName()) == $full_url ? route(Route::current()->getName())."?" : $full_url.'&' }}type=download" > <i class="fa fa-print"></i> {{__('common.download')}}  </a>
                    <a class="btn btn-sm  btn-success pull-right btn-print" href="{{ route(Route::current()->getName()) == $full_url ? route(Route::current()->getName())."?" : $full_url.'&' }}type=single_print"> <i class="fa fa-print"></i>{{__('common.single_page_print')}} </a>
                </div>
                ...
                <div class="box-body">
                    <div class="col-lg-6" style="padding-left: 0;padding-right: 0;">
                        <table class="table table-striped" id="dataTable">
                            ...
                            <tbody>
                            <tr>
                                <th colspan="3" class="text-center border-right-1"> -------{{__('common.credit')}}-------</th>
                            </tr>
                            <tr>
                                <th>{{__('common.serial')}}</th>
                                <th>{{__('common.particulars')}} </th>
                                <th>{{__('common.taka')}} </th>
{{--                                <th class="border-right-1 text-right">Total Taka</th>--}}
                            ...
                            @if($cash_balance >0 && in_array($transaction_method, ['Deposit', 'Income', 'Payment', 'Journal Entry']) )
                                <tr>
                                    <th colspan="1"></th>
                                    <th colspan="1"> {{__('common.balance')}}  {{__('common.credit')}}/{{__('common.debit')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td width="500px">
                                        @if( ($value->sale_id > 0 || ($value->item_name == $last_item && $value->item_name != null)) &&  $account_name== "Sales")
                                            <div style="width: 100%; float: left;">{{ $value->item_name}} </div>
                                        ...
                                        @else
                                            ...
                                            {!! $value->description ? "<br/>".$value->description : "" !!}
                                        @endif
...
{{--                                                    </td>--}}
                            ...
                            @endforeach
                            <tr>
                                <th colspan="2" class="text-right"> {{__('common.grand_total')}}</th>
                    ...
                    <div class="col-lg-6" style="padding-left: 0;padding-right: 0;">
                        <table class="table table-striped" id="dataTable">
                            ...
                            <tbody>
                            <tr>
                                <th colspan="4" class="text-center border-right-1"> ------- {{__('common.debit')}} -------</th>
                            </tr>
                            <tr>
                                <th>{{__('common.serial')}}</th>
                                <th>{{__('common.particulars')}} </th>
...
{{--                                @endif--}}
                            ...
                            <tr>
                                <th colspan="1" > </th>
                                <th colspan="1">{{__('common.total')}} </th>
