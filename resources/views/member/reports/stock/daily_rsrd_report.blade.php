...
$data['data'] = [
    ...
    'heading' => 'Daily Requisition, Sale, Return and Damage Report',
];
...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            {!! Form::open(['route' => 'member.report.daily_stock_report_by_requisition_damage','method' => 'GET', 'role'=>'form' ]) !!}
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    // $return_qty = $value['sales_requisition_qty']-$value['sale_qty'];
                    // $return_qty = $return_qty<0?0:$return_qty;
                    ...
                    $date = $value['date'];
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ create_money_format($value['sale_qty']*$value['price']) }}</td>
                            ...
                            <tr>
                                <td class="text-left" colspan="10">No Report Data Available</td>
                            </tr>

                            <?php }else{
                            ?>
                            <tr>
                                <th class="border-top-1 text-right padding-right-50" colspan="8"> Total</th>
                                <th class="border-top-1 text-right">{{ create_money_format($total) }}</th>
                                <td class="border-top-1 text-center"></td>
                            </tr>
                            <tr>
                                <th class="border-top-1 text-right padding-right-50" colspan="8"> Commission</th>
                                <td class="border-top-1 text-right"></td>
                                <td class="border-top-1 text-center"></td>
                            </tr>
                            <tr>
                                <th class="border-top-1 text-right padding-right-50" colspan="8"> Damage</th>
                                <th class="border-top-1 text-right">{{ create_money_format($total_damage_price) }}</th>
                                <td class="border-top-1 text-center"></td>
                            </tr>
                            <tr>
                                <th class="border-top-1 text-right padding-right-50" colspan="8"> Grand Total</th>
                                <td class="border-top-1 text-right"></td>
                                <td class="border-top-1 text-center"></td>
                            </tr>
                            <?php
