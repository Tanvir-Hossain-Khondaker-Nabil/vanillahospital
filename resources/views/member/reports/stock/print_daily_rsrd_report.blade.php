    ...
    <div style=" overflow: hidden; clear: both; float: inherit; text-align: center!important;">
        <table cellspacing="0" style="width:100%;" class="table" >
            ...
            <?php }else{
                ?>
            <tr>
                <th class="text-right padding-right-120" colspan="8"> Total</th>
                <th class="text-right">{{ create_money_format($total) }}</th>
                <td class="text-center"></td>
            </tr>
            <tr>
                <th class="text-right padding-right-120" colspan="8"> Commission</th>
                <td class="text-right"></td>
                <td class="text-center"></td>
            </tr>
            <tr>
                <th class="text-right padding-right-120" colspan="8"> Damage</th>
                <th class="text-right">{{ create_money_format($total_damage_price) }}</th>
                <td class="text-center"></td>
            </tr>
            <tr>
                <th class="text-right padding-right-120" colspan="8"> Grand Total</th>
                <td class="text-right"></td>
                <td class="text-center"></td>
            </tr>
            <?php
