...
$data['data'] = [
    'name' => 'Stock Report',
    'title'=> 'Stock Report',
    'heading' => trans('common.stock_report'),
];
...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            {!! Form::open(['route' => 'member.report.stocks','method' => 'GET', 'role'=>'form' ]) !!}
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        ...
                        <table class="table table-striped" id="dataTable">
                            ...
                            @foreach($stocks as $key=>$value)
                                <tr>
                                    ...
                                    <td>{{ $value->stock_details ? $value->stock_details->stock." ".$value->unit : 0 }}</td>
