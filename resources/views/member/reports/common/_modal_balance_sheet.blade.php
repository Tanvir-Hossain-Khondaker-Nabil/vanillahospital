    ...
    <div class="modal-dialog profit-loss-modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format( $inventory_no) }} Inventories</h4>
                ...
                <table class="table">
                    ...
                    @foreach($inventories as $key=>$value)
                        ...
                        @if( !empty($category) && $category != $value->category && $value->total_per_category>0)
                            <tr>
                                <td colspan="2">Total {{ $category }}</td>
                                <td class="single-line text-right"> {{ create_money_format($inventories[$key-1]['total_per_category']) }} </td>
                            </tr>
                        @endif
...
<div class="modal fade" id="fixed_assets" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($fixed_asset_no) }} Fixed Assets</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ create_money_format( $pre_fixed_asset ? $pre_fixed_asset->balance : 0) }}</td>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="dual-line text-right">{{ ($pre_total_fixed < 0 ? "(" : '').create_money_format( $pre_total_fixed).($pre_total_fixed < 0 ? ")" : '') }}</th><th class="dual-line text-right">{{ ($total_fixed < 0 ? "(" : '').create_money_format( $total_fixed).($total_fixed < 0 ? ")" : '') }}</th>
                                    </tr>
                                </table>
                ...
                <div class="modal fade" id="current_assets" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($current_asset_no) }} Others Current Assets</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ create_money_format( $pre_current_asset_balance) }}</td>
                ...
                <div class="modal fade" id="cash_and_banks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($cash_bank_no) }} Cash And Banks</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <div class="modal fade" id="trade_debtors" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($trade_debtors_no) }} Trade Debtors</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="advance_prepayment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($advance_prepayment_no) }} Advance Deposits & Prepayments</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="fixed_deposits_receipt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($fixed_deposits_receipt_no) }} Fixed Deposits Receipts</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="due_companies" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($due_affiliated_company_no) }} Due from Affiliated Company </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <div class="modal fade" id="account_payable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($account_payable_no) }} Account Payable</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="account_receivable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($account_receivable_no) }} Account Receivable</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="sundry_creditors" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($sundry_creditor_no) }} Sundry Creditors</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="overdraft_banks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($over_bank_no) }} Bank Overdraft</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                ...
                <div class="modal fade" id="non_current_liabilities" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($non_current_liability_no) }} Non-Current Liabilities</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ create_money_format( $pre_non_current_liability_balance) }}</td>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <div class="modal fade" id="current_liabilities" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($current_liability_no) }} Current Liabilities</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ create_money_format( $pre_current_liability_balance) }}</td>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="liabilities_expense" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($liabilities_expenses_no) }} Liabilities Expenses </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="2">Liabilities Expenses </td>
                                        <td class="text-right">{{ create_money_format( $pre_liabilities_expenses_balance) }}</td>
                                        <td class="text-right">{{ create_money_format( $liabilities_expenses_balance) }}</td>
                                    </tr>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="income_tax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($income_tax_no) }} Income Tax Payable </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="2"> Income Tax Payable </td>
                                        <td class="text-right">{{ create_money_format( $pre_income_tax_payable_balance) }}</td>
                                        <td class="text-right">{{ create_money_format( $income_tax_payable_balance) }}</td>
                                    </tr>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <!-- Modal -->
                <div class="modal fade" id="due_affiliated_no" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($due_affiliated_no) }} Due to Affiliated Company </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="2">Due to Affiliated Company </td>
                                        <td class="text-right">{{ create_money_format( $pre_due_to_affiliated_company_balance) }}</td>
                                        <td class="text-right">{{ create_money_format( $due_to_affiliated_company_balance) }}</td>
                                    </tr>
...
<td class="text-right">{{ ($value['balance'] < 0 ? "(" : '').create_money_format( $value['balance'] ).($value['balance'] < 0 ? ")":'') }}</td>
                ...
                <div class="modal fade" id="sales" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($sale_no) }} Sales</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($sale_details as $key=>$value)
                                        <tr>
                                            <td colspan="3">{{ $value->item->item_name }}</td>
                                            <td class="text-right">{{ create_money_format($value->sum_total_price) }}</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <th colspan="2">Total Sales</th>
                                        <th class="dual-line text-right">{{ create_money_format( $pre_total_sales) }}</th>
                ...
                <div class="modal fade" id="purchases" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog balance-sheet-modal" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLongTitle">{{ create_money_format($purchase_no) }} Purchases</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="dual-line text-right">{{ create_money_format( $pre_total_purchases_details) }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="dual-line text-right">{{ create_money_format( $pre_total_purchases_bank_charge) }}</th>
                                        <th class="dual-line text-right">{{ create_money_format( $total_purchases_bank_charge) }}</th>
                                    </tr>
                                    <tr>
                                        <th colspan="2">Total</th>
                                        <th class="dual-line text-right">{{ create_money_format( $pre_total_purchases) }}</th>
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-striped" id="dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-uppercase report-head-tag text-right padding-right-50 border-1 "> Previous Taka</td>
