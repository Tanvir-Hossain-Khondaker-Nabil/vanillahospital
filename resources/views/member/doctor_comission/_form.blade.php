                                ...
                                <table id="group_id_table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:12%;">Partiality</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select onchange="selectTest(this)" required id="test_name"
                                                    name="test_name[0][]" class=" form-control  select2" id=""
                                            ...
                                            <td>
                                                <input type="text" name="partiality[]" class="form-control">
                                            </td>
                                ...
                                @foreach ($comissions as $k => $value)
                                    @foreach ($value->comission as $key => $list)
                                        <tr>
                                            ...
                                            <td>{{ $list->subTestGroup ? $list->subTestGroup->title : '' }}
                                                ({{ $list->subTestGroup ? $list->subTestGroup->price : '' }})</td>
            ...
            $('#dynamic_row').append(
                ` <tr>
                    ...
                    <td>
                      ...
                      <td>
                                                    <input  type="text" name="partiality[]"
                                                        class="form-control">
                                                </td>
                    <td>
