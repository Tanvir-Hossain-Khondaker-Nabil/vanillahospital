...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        {!! Form::number('discount', @$model->discount ?? 0, [
            'id' => 'discount',
            'class' => 'form-control',
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function paidCalculation() {
            ...
            paid_is = parseInt(paid_amount)+parseInt(discount_amount);
            if(isNaN(paid_is)){
                paid_is= parseInt(discount_amount);;
            }
