...
<div class="col-md-6">
    <div class="form-group">
        <label for="name">City  Name <span class="text-red"> * </span> </label>
    ...
    <div class="form-group">
        ...
        {!! Form::select('division_id',$divisions, null,['id'=>'division_id','class'=>'form-control select2 select-region','placeholder'=>'Please select', 'required']); !!}
    </div>

    {{-- <div class="form-group">
        <label for="status">Select Region  <span class="text-red"> * </span>  </label>
        {!! Form::select('region_id',$regions, null,['id'=>'region_id','class'=>'form-control select2','placeholder'=>'Please select', 'required']); !!}
    </div> --}}
