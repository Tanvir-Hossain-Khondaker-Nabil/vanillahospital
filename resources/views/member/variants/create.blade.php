...
$data['data'] = [
    'name' => 'Add Variant',
    'title'=> 'Add Variant',
    'heading' => trans('common.add_variant'),
];
        ...
        <!-- general form elements -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{__('common.variant')}}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->

                {!! Form::open(['route' => 'member.variants.store','method' => 'POST', 'files'=>true, 'id'=>'variants', 'role'=>'form' ]) !!}
