...
$data['data'] = [
    'name' => 'Hospital Marketing Officer',
    'title' => 'List Of Hospital Marketing Officer',
    'heading' => 'List Of Hospital Marketing Officer',
];
            ...
            <div class="box">
                <div class="portlet light">
                    ...
                    <div class="box-header">
                        @if (\Auth::user()->can(['member.marketing_officer.create']))
                            <a href="{{ route('member.marketing_officer.create') }}" class="btn btn-info"> <i class="fa fa-plus">
                                </i>  Add Hospital Marketing Officer</a>
                        @endif
