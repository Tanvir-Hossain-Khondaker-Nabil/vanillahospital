...
$data['data'] = [
    'name' => ' Quotation Purchase',
    'title'=> ' Quotation Purchase',
    'heading' => ' Quotation Purchase',
];
    ...
    <div class="row">
        ...
        <!-- general form elements -->
            <div class="box box-primary">
                ...
                {!! Form::open(['route' => 'member.purchase_quotations.store','method' => 'POST', 'files'=>true, 'id'=>'purchase_form', 'role'=>'form' ]) !!}
                        ...
                        @foreach( $modal->quotation_details as $key => $value)
                            ...
                            <div class="box-body  purchase-quotation">
                                ...
                                <div class="col-md-1 px-0">
                                    ...
                                    {!! Form::number('qty[]',$value->qty-$value->purchase_qty,['id'=>'qty_'.$key,'class'=>'form-control input-number qty', 'required', 'step'=>"any"]); !!}
                                </div>
                                <div class="col-md-2">
