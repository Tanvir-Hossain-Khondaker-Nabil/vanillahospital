        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <a href="{{ route('member.requisition.create') }}" class="btn btn-xs btn-warning"><i class="fa fa-plus"></i> Add Requisition</a>
                    <a class="btn btn-xs btn-primary" href="{{ route('member.requisition.print_requisition', $requisition->id) }}" id="btn-print"><i class="fa fa-print"></i> Print</a>
                    @if(\Illuminate\Support\Facades\Auth::user()->can(['super-admin', 'admin']))
                    <a href="{{ route('member.requisition.edit',  $requisition->id) }}" class="btn btn-xs btn-success">
                        <i class="fa fa-pencil"></i> Edit
                    </a>
                    <a href="javascript:void(0);"  class="btn btn-xs btn-danger delete-confirm" data-target="{{route('member.requisition.destroy', $requisition->id)}}">
