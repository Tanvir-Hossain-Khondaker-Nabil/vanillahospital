...
<div class="box">
    <div class="box-body requisition-purchase-box">
        ...
        <div class="col-md-1">
            ...
            {!! Form::number('qty[]',null,['id'=>'qty_0','class'=>'form-control qty', 'required', 'step'=>"any", 'data-target'=>'0']); !!}
        </div>
        {{--<div class="col-md-1">--}}
            {{--<label for="amount"> Carton </label>--}}
        ...
        $(function () {
            ...
            $(document).on('click', '.add-row', function () {
                ...
                var html = '<div class="box-body requisition-purchase-box ">' +
                    ...
                    // '</div>' +
                    '<div class="col-md-1">'+
                    '<input id="qty_'+i+'"  data-target="'+i+'" class="form-control qty" min="0" name="qty[]" type="number">'+
                    '</div>'+
                    '<div class="col-md-1">' +
            ...
            function price_calculate(){
                ...
                for(var i = 1; i<=$('.requisition-purchase-box').length; i++) {
                    ...
                    var price = $('.requisition-purchase-box:nth-child(' + i + ') div:nth-child(5) input').val();
                    ...
                    $('.requisition-purchase-box:nth-child(' + i + ') div:nth-child(6) input').val(total_price);
                }
                ...
                // using the done promise callback
                    .done(function(data) {
                        ...
                        if(data.status == "success")
                        {
                            ...
                            // $('#last_purchase_qty_'+id).val(data.last_purchase_qty ? data.last_purchase_qty : 0);
                            // $('#last_purchase_price_'+id).val(data.last_price ? data.last_price : 0);
                        }else{
//                        console.log(data);
