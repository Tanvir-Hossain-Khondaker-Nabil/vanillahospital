...
$route = \Auth::user()->can(['member.opd.paid.patient.list']) ? route('member.opd.paid.patient.list') : '#';
...
$data['data'] = [
    ...
    'title' => 'List Of OPD Paid Patient',
    'heading' => 'List Of OPD Paid Patient',
];
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="py-5">
                                        <form action="{{ route('member.opd.paid.patient.list') }}" method="GET">
                                            @csrf
