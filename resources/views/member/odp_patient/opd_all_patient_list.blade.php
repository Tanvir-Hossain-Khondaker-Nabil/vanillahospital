...
$route = \Auth::user()->can(['member.opd.all.patient.list']) ? route('member.opd.all.patient.list') : '#';
...
$data['data'] = [
    'name' => 'OPD All Patient List',
    'title' => 'List Of OPD All Patient',
    'heading' => 'List Of OPD All Patient',
];
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="py-5">
                                        <form action="{{ route('member.opd.all.patient.list') }}" method="GET">
                                            @csrf
