...
$data['data'] = [
    'name' => 'Live Consultation',
    'title' => 'List Of Live Consultation',
    'heading' => 'List Of Live Consultation',
];
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="box-header">
                            ...
                            <a href="{{ route('member.live_consultation.create') }}" class="btn btn-info"> <i class="fa fa-plus">
                                </i> Add Live Consultation</a>
                            @endif
                    ...
                    <div id="table_data" class="box-body table-responsive relative">
                        ...
                        @include('member.live_consultation.table')
