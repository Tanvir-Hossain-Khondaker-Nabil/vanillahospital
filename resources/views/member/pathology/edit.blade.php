            ...
            <div class="container">
                            ...
                            <table class="table table-responsive table-striped">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <th>Specimen: </th>
                                    <td>
                                        {{ $models->testGroup->specimen->specimen }}
                                    </td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {!! Form::open([
                            'route' => 'member.pathology_final_reports.store',
                            'method' => 'POST',
                            'files' => 'true',
                            'role' => 'form',
                        ]) !!}
                        ...
                        <div class="box" style="margin-top: 20px">
                            ...
                            <div class="box-body" style="margin-top: 20px">
                                ...
                                <div class="col-md-5">
                                    {{-- {{dd($models)}} --}}
                                    <input type="hidden" value="{{ $patient_test->sub_test_group_id }}" name="sub_test_group_id">
                                    <input type="hidden" value="{{ $patient_test->out_door_registration_id }}" name="out_door_registration_id">
                                    <input type="hidden" value="{{ $patient_test->id }}" name="out_door_patient_test_id">
                                ...
                                <div style="margin-top: 100px">
                                    ...
                                    <textarea id="summernote" class=" form-control" name="description">
                                        {!! $models->pathologyReport->description !!}
