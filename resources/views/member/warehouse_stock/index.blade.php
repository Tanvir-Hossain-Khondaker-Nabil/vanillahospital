        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="portlet light">
                    ...
                    {!! Form::open(['route' => 'member.warehouse.history.index','method' => 'GET', 'role'=>'form' ]) !!}
                    <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                {{--<div class="col-md-3">--}}
                                ...
                                <div class="col-md-3">
                                    <label>  Type </label>
                                    {!! Form::select('type', $types, null,['id'=>'type','class'=>'form-control select2','placeholder'=>'Select All']); !!}
                                </div>
