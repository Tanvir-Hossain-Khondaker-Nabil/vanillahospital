...
<div id="page-wrap">
    ...
    <div>
        <h2 style="margin: 10px auto!important">{{__('common.stock_overflow_report')}}</h2>
    </div>
    <div >
        <table cellspacing="0" width="100%" class="table">
            ...
            <tbody>
            @forelse($gain_stocks as $key=>$value)
                <tr>
            ...
            @empty
                <tr>
                    <td class="text-center" colspan="5">{{__('common.no_report_available_for_stock')}}</td>
                </tr>
            @endforelse
            </tbody>
        </table>
