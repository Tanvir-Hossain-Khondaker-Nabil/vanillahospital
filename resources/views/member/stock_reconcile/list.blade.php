...
@section('contents')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            {!! Form::open(['route' => 'member.report.gain_reconcile_stocks','method' => 'GET', 'role'=>'form' ]) !!}
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">{{__('common.stock_overflow_report')}}</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="col-lg-12">
                        <table class="table table-striped" id="dataTable">
                            ...
                            @foreach($gain_stocks as $key=>$value)
                                <tr>
                                    <td>{{ $key+1 }}</td>
