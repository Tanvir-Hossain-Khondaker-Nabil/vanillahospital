...
$route = \Auth::user()->can(['member.opd.test_discount_management_report']) ? route('member.opd.test_discount_management_report') : '#';
...
$data['data'] = [
    'name' => 'OPD Management Report',
    'title' => 'OPD Management Report',
    'heading' => 'OPD  Management Report',
];
