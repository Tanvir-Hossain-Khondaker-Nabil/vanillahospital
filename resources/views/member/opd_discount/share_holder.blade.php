                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="py-5">
                                        <form action="{{ route('member.opd.share_holder_report.search') }}" method="POST">
                                            @csrf
                                            <div class="card-body border-bottom row">

                                                <div class="col-lg-3 col-md-3 col-12">
                                                    <label>{{ __('Share Holder Name') }}</label>
                                                    <select class="form-control select2" name="share_holder_id">
                                                        <option value="">Please Select</option>
                                                        <option value="all">All</option>
                                                        @foreach ($share_holder as $key => $value)
