...
@endpush
    ...
    <div class="col-md-7">
        ...
        <div class="form-group {{ $errors->has('term_id') ? 'has-error' : '' }}">
            <label for="term_id">Select Parent Term <span class="text-red"> * </span> </label>
            {!! Form::select('term_id', $terms , null,['id'=>'term_id','class'=>'form-control select2','placeholder'=>'Please select Parent Term', 'required']); !!}
        </div>
