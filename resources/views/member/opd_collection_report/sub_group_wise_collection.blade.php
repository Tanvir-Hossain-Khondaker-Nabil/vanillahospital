...
$data['breadcrumb'] = [
    ...
    [
        'name' => 'OPD Sub Group Wise Collection',
        'href' => $route,
    ],
    [
        'name' => 'Index',
...
$data['data'] = [
    ...
    'title' => 'List Of OPD Sub Group Wise Collection',
    'heading' => 'List Of OPD SUb Group Wise Collection',
];
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="py-5">
                                        <form action="{{ route('member.sub_group_wise.collection.search') }}" method="POST">
                                            @csrf
                                            <div class="card-body border-bottom row">

                                                <div class="col-lg-3 col-md-3 col-12">
                                                    <label>{{ __('Sub Group Name') }}</label>
                                                    <select class="form-control select2" name="sub_test_group_id">
                                                        <option value="">Please Select</option>
                                                        <option value="all">All</option>
                                                        @foreach ($sub_test_group as $key => $value)
