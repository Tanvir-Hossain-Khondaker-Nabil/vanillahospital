...
$route = \Auth::user()->can(['member.group_wise.collection.list']) ? route('member.group_wise.collection.list') : '#';
...
$data['breadcrumb'] = [
    ...
    [
        'name' => 'OPD Group Wise Collection Report',
        'href' => $route,
    ],
    [
        'name' => 'Index',
...
$data['data'] = [
    'name' => 'OPD Group Wise Collection List',
    'title' => 'List Of OPD Group Wise Collection Report',
    'heading' => 'List Of OPD Group Wise Collection Report',
];
                    ...
                    <div class="invoice white shadow">
                        ...
                        <div class="row pl-5 pr-5 my-3">
                            <div class="col-12 table-responsive">
                                <p style="text-align:center;font-size:14px;color:#000;font-weight:bold;"> Report of OPD Test Group Wise
                                ...
                                <h2 align="center">{{$tes_group->title}} </h2>
                                ...
                                <table id="test_table"
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td style="font-size:16px;font-weight:bold" colspan="4" align="right">Total:</td>
