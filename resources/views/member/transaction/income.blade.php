...
$data['data'] = [
    'name' => 'Add Income',
    'title'=> 'Add Income',
    'heading' =>  trans('common.add_income'),
];
        ...
        <!-- general form elements -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{__('common.income')}}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->

                {!! Form::open(['route' => 'member.transaction.incomeStore','method' => 'POST', 'files'=>true, 'role'=>'form' ]) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="box-group head-trans">
                        ...
                        <div class="col-md-3">
                            <label for="category_id">{{__('common.income_from')}} </label>
                            {!! Form::select('income_from', $transaction_categories, null,['id'=>'account_name_1', 'data-option'=>'1', 'class'=>'form-control acc_name select2','required', 'placeholder'=>trans('common.select_account_name')]); !!}
                        </div>
                    ...
                    <div class="box journal-entry-box">
                        ...
                        <div class="box-body">
                            <div class="col-md-2">
                                <label for="category_id"> {{__('common.code')}} </label>
                            ...
                            <div class="col-md-3">
                                <label for="category_id">{{__('common.income_to')}} </label>
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="notation"> {{__('common.notation')}} Notation  </label>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(document).on('click', '.add-row', function () {
                ...
                var $div = $(this).parent().parent().parent('.box-body');
            ...
            $('#submit').click( function () {
                ...
                for(i=0; i<=totalRow; i++)
                {
                    ...
                    if(transType=='dr'){
                        drAmount = drAmount+parseFloat($('#amount_'+i).val());
                    }else if(transType=='cr'){
                        crAmount = crAmount+parseFloat($('#amount_'+i).val());
                    }
                }

                if(drAmount != crAmount)
                {
                    bootbox.alert(" Debit and Credit amount is not same ");
                    return false;
                }
            });
