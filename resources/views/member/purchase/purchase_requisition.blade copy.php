...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            {!! Form::open(['route' => 'member.purchases_by_requisition.store','method' => 'POST', 'files'=>true,
            'id'=>'purchase_form', 'role'=>'form' ]) !!}
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="col-md-2">
                            ...
                            {!! Form::text('date', create_date_format($modal->date,'/'),['id'=>'date',
                            'class'=>'form-control','required']); !!}
                        </div>
                        <div class="col-md-3">
                            <label for="supplier_id"> Supplier Name </label>
                            {!! Form::select('supplier_id', $suppliers, null,['id'=>'supplier_id',
                            'class'=>'form-control select2','required', 'placeholder'=>'Select Supplier Name']); !!}
                ...
                <div class="box">
                    ...
                    <div class="box-body purchase-box">
                        <div class="col-md-3">
                            ...
                            {!! Form::select('product_id[]', $products, $value->item_id,['id'=>'product_id_'.$key,
                            'data-option'=>$key, 'class'=>'form-control select2 item-name','required',
                            'placeholder'=>'Select Item Name', !$loop->last ? "readonly":'']); !!}
                        </div>

                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Unit </label> @endif
                            {!! Form::text('unit[]',$value->unit,['id'=>'unit_'.$key,'class'=>'form-control',
                            'readonly']); !!}
                        </div>
                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Last Purchase Qty </label> @endif
                            {!!
                            Form::number('last_purchase_qty[]',0,['id'=>'last_purchase_qty_'.$key,'class'=>'form-control',
                            'readonly']); !!}
                        </div>
                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Available Stock </label> @endif
                            {!! Form::number('available_stock[]',0,['id'=>'stock_'.$key,'class'=>'form-control',
                            'readonly']); !!}
                        </div>

                        {{--                                <div class="col-md-1">--}}
                        {{--                                    @if($key==0) <label for="amount"> Sales Price </label> @endif--}}
                        {{--                                    {!! Form::number('sales_price[]',0,['id'=>'sales_price_'.$key,'class'=>'form-control', 'readonly']); !!}--}}
                        {{--                                </div>--}}
                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Qty </label> @endif
                            {!! Form::number('qty[]',$value->qty,['id'=>'qty_'.$key,'class'=>'form-control qty',
                            'step'=>"any", 'required']); !!}
                        </div>
                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Price </label> @endif
                            {!! Form::number('price[]',$value->price,['id'=>'price_'.$key,'class'=>'form-control
                            input-number price','placeholder'=>' Price', 'step'=>"any", 'required']); !!}
                        </div>
                        <div class="col-md-1">
                            @if($key==0) <label for="amount"> Total Price </label> @endif
                            {!!
                            Form::number('total_price[]',$value->qty*$value->price,['id'=>'total_price_'.$key,'class'=>'form-control
                            input-number','placeholder'=>'Total Price', 'step'=>"any", 'required', 'readonly']); !!}
                        </div>
                        <div class="col-md-1">
                            @if($key==0) <label for="description">Description </label> @endif
                            {!! Form::text('description[]',null,['id'=>'description','class'=>'form-control'
                            ,'placeholder'=>'Enter Description','height'=>'70px !important' ]); !!}
                        </div>
                        <div class="col-md-1" style=" padding-top:{{ $loop->last ?  "20px" : "30px" }}">
                            @if($loop->last)
                            <a class="btn btn-success add-row pull-right margin-top-3" href="#"><i
                                    class="fa fa-plus-circle"></i> </a>
                            @else
                            <a href="#" class="btn-text-info margin-top-3  margin-top-23 edit-button"><i
                                    class="fa fa-pencil"></i></a><a href="#"
                                class="btn-text-danger margin-top-23 delete-field"><i class="fa fa-close"></i></a>
                            @endif
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('notation',null,['id'=>'notation','class'=>'form-control'
                                ,'placeholder'=>'Enter Notation','height'=>'70px !important' ]); !!}
                            </div>
                            <div class="form-group">
                                <label for="product_id">Cash or Bank Account </label>
                                {!! Form::select('cash_or_bank_id', $banks, null,['class'=>'form-control select2
                                ','required', 'placeholder'=>'Select Account Name']); !!}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                ','placeholder'=>'Enter Transport Vehicle Number']); !!}
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!!
                                Form::number('total_bill',$modal->total_price,['id'=>'total_bill','class'=>'form-control
                                input-number','placeholder'=>'Enter Price', 'step'=>"any", 'required', 'readonly']); !!}
                            </div>
                            <div class="form-group">
                                <label for="due_advance" id="due_advance"> Advance</label>
                                {!! Form::number('due_amount',0 ,['id'=>'total_due_adv','class'=>'form-control
                                input-number','placeholder'=>'Enter Price', 'step'=>"any", 'required', 'readonly']); !!}
                            </div>
                            <div class="form-group">
                                <label for="amount"> Discount Type</label>
                                {!! Form::select('discount_type', ['Fixed'=>'Fixed', 'Percentage'=>'Percentage'],
                                null,['id'=>'discount_type','class'=>'form-control']); !!}
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::number('transport_cost', 0,['id'=>'transport_cost','class'=>'form-control
                                input-number','placeholder'=>'Enter Amount', 'step'=>"any", 'required']); !!}
                            </div>
                            <div class="form-group">
                                <label for="unload_cost"> Unload Cost</label>
                                {!! Form::number('unload_cost', 0, ['id'=>'unload_cost','class'=>'form-control
                                input-number','placeholder'=>'Enter Amount', 'step'=>"any", 'required']); !!}
                            </div>
                            <div class="form-group">
                                <label for="amount"> Total Amount</label>
                                {!!
                                Form::number('total_amount',$modal->total_price,['id'=>'total_amount','class'=>'form-control
                                input-number','placeholder'=>'Enter Price', 'step'=>"any", 'required', 'readonly']); !!}
                            </div>
                            <div class="form-group">
                                <label for="amount"> Amount to Pay </label>
                                {!!
                                Form::number('amount_to_pay',$modal->total_price,['id'=>'amount_to_pay','class'=>'form-control
                                input-number','placeholder'=>'Enter Price', 'step'=>"any", 'required', 'readonly']); !!}
                            </div>
                            <div class="form-group">
                                <label for="amount"> Paid Price</label>
                                {!! Form::number('paid_amount',null,['id'=>'paid_amount','class'=>'form-control
                                input-number','placeholder'=>'Enter Price', 'step'=>"any", 'required']); !!}
                            </div>
...
$(function() {
    ...
    var i = {
        {
            count($modal - > requisition_details)
        }
    };
    ...
    $(document).on('click', '.add-row', function() {
        ...
        if ($div.find('div :first-child').find('select').val() == "" || $div.find('div :nth-child(5)')
            .find('input').val() == "" || $div.find('div :nth-child(6)').find('input').val() == "") {
        ...
        var html = '<div class="box-body purchase-box ">' +
            ...
            '<div class="col-md-1">' +
            '<input id="unit_' + i +
            '" readonly  min="0" class="form-control" name="unit[]" type="text">' +
            '</div>' +
            '<div class="col-md-1">' +
            ...
            '<div class="col-md-1">' +
            '<input id="qty_' + i +
            '" class="form-control qty" step="any" min="0" name="qty[]" type="number">' +
            '</div>' +
            '<div class="col-md-1">' +
            '<input placeholder=" Price"  min="0"  id="price_' + i + '" data-option="' + i +
            '" class="form-control price input-number" step="any" name="price[]"  type="number"/>' +
            '</div>' +
            '<div class="col-md-1">' +
            '<input placeholder="Total Price" min="0"  id="price_' + i + '" data-option="' + i +
            '" class="form-control input-number" step="any" name="total_price[]"  type="number"/>' +
            '</div>' +
            '<div class="col-md-1">' +
            '{!! Form::text('
        description[]
    ...
    $(document).on('click', '#edit-complete', function() {
        ...
        var actionHtml =
            '<a href="#" class=" btn-text-info margin-top-3 edit-button"><i class="fa fa-pencil"></i></a><a href="#" class="btn-text-danger margin-top-23 delete-field"><i class="fa fa-close"></i></a>';
        $(this).parent('div').html(actionHtml);
    ...
    $("#supplier_id").change(function(e) {
        ...
        $.ajax({
            ...
            if (data.status == "success") {
                ...
                var html = "<b> Current Balance: " + data.supplier.supplier_current_balance +
                    "</b><br/>";
                html += "<b> Last Purchase Amount: " + (data.last_purchase_amount == null ? 0 :
                    data.last_purchase_amount.total_amount) + "</b>";
