    ...
    $(function () {
                        ...
                        if(data.stock>0)
                        {
                            ...
                            if(inList>=0)
                            {
                                ...
                                var html = '<tr > <td>' + i + '</td> <td>' + product_name + '<input type="hidden" name="product_id[]" value="' + data.id + '" /> <input type="hidden" id="stock_' + data.id + '" value="' + data.stock + '"  /></td> ' +
                                    ...
                                    '<td><input type="number" tabindex="-1" min="0" name="price[]" readonly value="' + (data.price != null ? data.price : 0) + '" id="price_' + data.id + '" data-option="' + data.id + '" class="price text-right px-2" style="width: 80px; "></td> ' +
                                    '<td style="width: 100px;" id="total_price_' + data.id + '"  class="total_price text-bold text-right px-2">' + (data.price != null ? data.price * 1 : 0) + '</td> ' +
        ...
        function price_calculate(){
            ...
            for(var i = 0; i<=$tr.find('tr').length; i++) {
                ...
                $tr.find('tr:nth-child('+i+') td:nth-child(6) ').text(total_price.toFixed(2));
