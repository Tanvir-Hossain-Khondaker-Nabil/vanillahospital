...
$data['data'] = [
    'name' => 'Add Category',
    'title'=> 'Add Category',
    'heading' => trans('common.add_category'),
];
        ...
        <!-- general form elements -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{__('category.category')}}</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->

                {!! Form::open(['route' => 'member.categories.store','method' => 'POST', 'files'=>true, 'id'=>'categories', 'role'=>'form' ]) !!}
