...
class QuotationTermDataTable extends DataTable
{
    /**
    ...
    public function  ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function($modal) {
                return view('common._action-button', ['model' => $modal, 'route' => 'member.quotation_terms']);
            })
            ->make(true);
    }
    ...
    {
        $query = QuotationTerm::parent()->latest();
