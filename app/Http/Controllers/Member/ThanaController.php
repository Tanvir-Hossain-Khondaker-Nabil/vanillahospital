...
class ThanaController extends Controller
{
    ...
    {
        return $dataTable->render('member.thanas.index');
    }
    ...
    public function create()
    {
        ...
        return view('member.thanas.create', $data);
    }
    ...
    {
        $data['model'] = Thana::findOrFail($id);

        $data['divisions'] = Division::active()->get()->pluck('name', 'id');
        $data['regions'] = Region::active()->get()->pluck('name', 'id');
        $data['districts'] = District::active()->get()->pluck('name', 'id');

        return view('member.thanas.edit',$data);
    }
